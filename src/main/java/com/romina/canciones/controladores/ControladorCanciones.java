package com.romina.canciones.controladores;
...
import com.romina.canciones.servicios.ServicioCanciones;
...
public class ControladorCanciones {
    ...
    public String index(Model model) {
        model.addAttribute("mensaje", "Bienvenido al proyecto Canciones");
        return "inicio";
    }
